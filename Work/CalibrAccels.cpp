...
{
	CompensateAccelsBias(sPar, Acc_raw,	Acc);							
	CompensateAccelsScales(sPar, Acc, Acc);								
	CompensateAccelsElasic(sPar, Acc, Acc);								
	CompensateAccelTimingSkewAdjustment(sPar, omg, Acc);				
}
//----------------------------------


//Compensate Accels Bias
...
//Compensate Accels Scales
void CompensateAccelsScales(Par* sPar, double* Acc_raw, double* Acc) 
{
	double DeltaAcc[3] = { 0.0, 0.0, 0.0 };
...
// Compensate Accels Ellastic Scales
